export var GLOBAL = {
  //url: 'http://192.168.0.10/joseluisestudiante/php-backend/index.php/',
  ...
  //urlFiles: 'http://192.168.0.229/ltesoluciones/php-backend/App/public'
  ...
  url: 'http://localhost/devLTE/trunk/DeveloperPro-App/public/index.php/',
  urlFiles: 'http://localhost/devLTE/trunk/DeveloperPro-App/App/public'
};
