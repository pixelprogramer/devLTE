            ...
            if ($json != null) {
                ...
                if ($token != null) {
                    ...
                    if ($validacionToken == true) {
                        ...
                        $sql = "select co_coun.* from configuration.co_countries co_coun where co_coun.co_country_active = '1' and co_coun.co_country_description like '$co_country_description'";
                        ...
                        if ($r == 0) {
                            ...
                            $data = [
                                'code' => '1007',
                                'msg' => 'Este pais ya existe: ' . $co_country_description
                            ];
                        }
                    } else {
                        $data = [
